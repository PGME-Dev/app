  ...
  Widget _buildPackageDetailView(
    ...
    if (totalLectures > 0) {
      cards.add(_buildOptionCard(
        ...
        imageUrl: _selectedPackage?.videoLecturesThumbnailUrl,
        isDark: isDark,
    ...
    if (totalDocuments > 0) {
      cards.add(_buildOptionCard(
        ...
        imageUrl: _selectedPackage?.notesThumbnailUrl,
        isDark: isDark,
        gradientStart: gradientStart,
        gradientEnd: gradientEnd,
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Text('Learn More', style: TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w500, fontSize: btnFontSize, color: Colors.white)),
                        ),
                      ),
                    ],
                  ),
